  ...
  return (
    <div>
      ...
      <div>
              ...
              <div className="col-lg-6 img-bg" style={{ backgroundImage: `url('assets/img/alt-services.jpg')` }} data-aos="zoom-in" data-aos-delay="100"></div>
                ...
                <div className="col-lg-5 d-flex flex-column justify-content-center">
                  ...
                  <div className="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                      <h4 className="stretched-link">Lorem Ipsum</h4>
                  ...
                  <div className="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div>
                      <h4 className="stretched-link">Nemo Enim</h4>
                  ...
                  <div className="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div>
                      <h4 className="stretched-link">Dine Pad</h4>
                  ...
                  <div className="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
                    <i className="bi bi-brightness-high flex-shrink-0"></i>
                    <div>
                      <h4 className="stretched-link">Tride clov</h4>
          ...
          <section id="alt-services-2" className="alt-services section-bg">
            <div className="container" data-aos="fade-up">
              ...
              <div className="row justify-content-around gy-4">
                ...
                <button className="col-lg-6 img-bg" style={{ backgroundImage: `url(assets/img/alt-services-2.jpg)` }} data-aos="zoom-in" data-aos-delay="100"></button>
            ...
            <div className="container" data-aos="fade-up">
              ...
              <div className="row gy-5">
                ...
                <div className="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
                  <div className="member-img">
                    ...
                    <div className="social">
                      <a href="/home"><i className="bi bi-twitter"></i></a>
                      <a href="/home"><i className="bi bi-facebook"></i></a>
                      <a href="/home"><i className="bi bi-instagram"></i></a>
                      <a href="/home"><i className="bi bi-linkedin"></i></a>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
                  <div className="member-img">
                    <img src="assets/img/team/team-6.jpg" className="img-fluid" alt=""></img>
                    <div className="social">
                      <a href="/home"><i className="bi bi-twitter"></i></a>
                      <a href="/home"><i className="bi bi-facebook"></i></a>
                      <a href="/home"><i className="bi bi-instagram"></i></a>
        ...
        <a href="/home" className="scroll-top d-flex align-items-center justify-content-center"><i className="bi bi-arrow-up-short"></i></a>
